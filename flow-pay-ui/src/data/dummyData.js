...
export const DUMMY_PLANS = [
  {
    ...
    price: 199,
    interval: "month",
    features: ["5 seats", "10K API calls/mo", "Email support", "Basic analytics"],
    subscribers: 312,
    color: "#38bdf8",
  },
  {
    ...
    price: 999,
    interval: "month",
    features: ["25 seats", "100K API calls/mo", "Priority support", "Advanced analytics", "Webhooks"],
    subscribers: 748,
    color: "#818cf8",
  },
  {
    ...
    price: 4999,
    interval: "month",
    features: ["Unlimited seats", "Unlimited API calls", "24/7 dedicated support", "Custom analytics", "SLA 99.99%", "Custom integrations"],
    subscribers: 224,
    color: "#f59e0b",
  },
];
