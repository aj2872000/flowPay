...
const apiKeySchema = new mongoose.Schema({
  ...
  // Store only a SHA-256 hash — never the raw secret
  keyHash:   { type: String, required: true, select: false },
  prefix:    { type: String, required: true },   // "sk_live_" or "sk_test_"
  last4:     { type: String, required: true },   // last 4 chars of the raw key
